...
if ( ! class_exists( 'Cherry_Blog_Layout_Options' ) ) {
	...
	/**
	 * Sets up and initializes the Cherry blog options.
	 *
	 * @since 1.0.0
	 */
		...
		public function add_options( $sections ) {
			...
			$layout_options = array(
				...
				'blog-layout-grid-column' => array(
					'type'			=> 'radio',
					'title'			=> __( 'Grid columns', 'cherry-blog-layouts' ),
					'description'	=> __( 'Select grid layout pattern for pages with custom blog layout', 'cherry-blog-layouts' ),
					'value'			=> 'grid-4',
					'display_input'	=> false,
					'options'		=> array(
						'grid-2' => array(
							'label'   => __( 'Grid 2', 'cherry-blog-layouts' ),
							'img_src' => CHERRY_BLOG_URI . '/public/assets/images/blog-layout-grid-2.svg',
						),
						'grid-3' => array(
							'label'   => __( 'Grid 3', 'cherry-blog-layouts' ),
							'img_src' => CHERRY_BLOG_URI . '/public/assets/images/blog-layout-grid-3.svg',
						),
						'grid-4' => array(
							'label'   => __( 'Grid 4', 'cherry-blog-layouts' ),
							'img_src' => CHERRY_BLOG_URI . '/public/assets/images/blog-layout-grid-4.svg',
						),
						'grid-6' => array(
							'label'   => __( 'Grid 6', 'cherry-blog-layouts' ),
				...
				'blog-layout-columns' => array(
					'type'			=> 'slider',
					'title'			=> __( 'Masonry columns number', 'cherry-blog-layouts' ),
					'description'	=> __( 'Specify custom masonry layout columns number', 'cherry-blog-layouts' ),
					'max_value'		=> 12,
					'min_value'		=> 1,
					'value'			=> 3,
				),
				'blog-layout-columns-gutter' => array(
					'type'			=> 'slider',
					'title'			=> __( 'Masonry columns gutter', 'cherry-blog-layouts' ),
					'description'	=> __( 'Specify custom masonry layout columns gutter(px)', 'cherry-blog-layouts' ),
					'max_value'		=> 100,
					'min_value'		=> 0,
					'value'			=> 10,
				),
				'blog-layout-timeline-item-width' => array(
					'type'			=> 'slider',
					'title'			=> __( 'Timeline item width', 'cherry-blog-layouts' ),
					'description'	=> __( 'Specify custom item width for Timeline blog layout(%)', 'cherry-blog-layouts' ),
					'max_value'		=> 50,
					'min_value'		=> 10,
					'value'			=> 48,
				),
				...
				'blog-layout-grid-type' => array(
					'type'			=> 'radio',
					'title'			=> __( 'Grid type', 'cherry-blog-layouts' ),
					'description'	=> __( 'Select layout pattern for pages with custom blog layout. Wide layout will fit window width. Boxed layout will have fixed width.', 'cherry-blog-layouts' ),
					'value'			=> 'inherit',
					'display_input'	=> false,
					'options'		=> array(
						'inherit' => array(
							'label'   => __( 'Inherit', 'cherry-blog-layouts' ),
							'img_src' => PARENT_URI . '/lib/admin/assets/images/svg/inherit.svg',
						),
						'wide' => array(
							'label'   => __( 'Wide', 'cherry-blog-layouts' ),
							'img_src' => PARENT_URI . '/lib/admin/assets/images/svg/grid-type-fullwidth.svg',
						),
						'boxed' => array(
							'label'   => __( 'Boxed', 'cherry-blog-layouts' ),
				...
				'blog-layout-sidebar-position' => array(
					...
					'hint'        => array(
						'type'    => 'text',
						'content' => __( 'You can choose if you want to display sidebars and how you want to display them.', 'cherry-blog-layouts' ),
					),
					'value'         => 'inherit',
					'display_input' => false,
					'options'       => array(
